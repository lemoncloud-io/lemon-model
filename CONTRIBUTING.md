# Contributing to lemon-model

Thanks for your interest in contributing to `lemon-model` (lemoncloud-io/lemon-model)! This document
...
3. Node version — this repo requires **`>=18.19.0`** (from
...
project's [MIT License](LICENSE), the same license as `lemon-model`.
